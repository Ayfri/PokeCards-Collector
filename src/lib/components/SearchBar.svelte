...
<div class="relative {mobileMode ? 'flex flex-col w-full' : ''}">
	<div class="search-container relative">
		...
		<input
			...
			class="bg-black text-white px-4 py-2 rounded-full w-full outline-none pl-10 pr-10 {mobileMode ? '' : 'pr-24'} transition-all duration-300 ease-in-out {inputFocused ? 'ring-2 ring-gold-400 shadow-lg shadow-gold-400/20' : 'ring-1 ring-transparent border border-gray-700 hover:border-gray-500'}"
