...
<a
	class="group bg-gray-800 dark:bg-gray-900 border border-gray-700 dark:border-gray-600 rounded-xl overflow-hidden transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl {hoverBorderClass} {hoverShadowClass} cursor-pointer focus:outline-none focus:ring-0"
...
>
	<div class="p-4 flex flex-col items-center text-center space-y-1.5">
		...
		<h4 class="text-lg font-semibold text-white dark:text-gray-100 group-hover:text-gold-400 dark:group-hover:text-gold-400 transition-colors duration-200 truncate w-full pt-1">{user.username}</h4>
		<div class="text-sm text-gray-300 dark:text-gray-400 space-y-0.5">
			...
			<p class="flex items-center justify-center gap-1.5 text-gray-400 dark:text-gray-500 text-xs">
